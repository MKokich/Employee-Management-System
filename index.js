        ...
        .then(function (answer) {
          ...
          connection.query(
            ...
            (err) => {
              if (err) throw err;
              console.log(
                `Successfully added ${answer.first_name} ${answer.last_name} to Employees`
              );
              mainMenu();
            }
          );
...
addDept = () => {
  inquirer
    ...
    .then(function (answer) {
      ...
      console.log(
        `${answer.newDepartment} has successfully been added to Departments`
      );
      mainMenu();
    });
};
        ...
        .then(function (answer) {
          connection.query(
            ...
            (err) => {
              if (err) throw err;
              console.log(
                `${answer.title} has successfully been added to Roles`
              );
              mainMenu();
            }
          );
